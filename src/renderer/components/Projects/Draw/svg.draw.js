...
import SVG from 'svg.js'
  ...
  PaintHandler.prototype.transformPoint = function (x, y) {
    // if (this.el.array().valueOf().length < 2) {
    //   this.p.x = x - (this.offset.x - window.pageXOffset)
    //   this.p.y = y - (this.offset.y - window.pageYOffset)
    //
    //   return this.p.matrixTransform(this.m)
    // }
    console.log(this.el.array().valueOf(), this.options.viewPlan)

    switch (this.options.viewPlan) {
      case 'iso-left':
        this.p.x = x - (this.offset.x - window.pageXOffset)
        this.p.y = (this.el.array().valueOf().length < 2) ? y - (this.offset.y - window.pageYOffset) : this.p.x / 2
        //  + this.p.x / 2
        // console.log(x, y)
        break
      default:
  ...
  // SVG.Element.prototype.draw.params = function (key, value) {
  //   console.log(this.options)
  //   return this.options
  //   // return this.options[key]
  //   // console.log(key)
  //   // return this.el.draw.defaults[key]
  // }
