<template>
  <div class="columns">
    ...
    <div class="column">
      <div class="tabs is-boxed" v-if="selectedRoom">
        <ul>
      ...
      <div class="content">
        <p v-if="selectedRoom">
          <strong>#{{ selectedRoom._number }} - {{ selectedRoom._name }}</strong> <small>Edité le <time datetime="2016-1-1">11:09 PM - 1 Jan 2016</time></small>
          <br>
...
export default {
  ...
  computed: {
    ...
    selectedMany () {
      return this.selectedRooms && this.selectedRooms.length > 1
    }
  },
  watch: {
